...
public class ShowTransactionDialogFragment extends DialogFragment {
    ...
    private void initView(View dialogView){
        ...
        descriptionText.setText(transactionToShow.getTitle());
        ...
        creationDateText.setText(
                String.format(
                "Created : %s",
                AppUtils.formatDate(new Date(transactionToShow.getDate()), AppUtils.MAIN_DATE_FORMAT)));
